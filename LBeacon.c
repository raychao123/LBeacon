...
int enable_advertising(int advertising_interval, char *advertising_uuid, int rssi_value)
{
...
//E2 C5 6D B5 DF FB 48 D2 B0 60 D0 F5 11 11 11 11
    ...
    memcpy(g_filepath + g_config.filepath_len - 1, g_config.filename,
     ...
     sprintf(hex_c, "E2C56DB5DFFB48D2B060D0F5%02x%02x%02x%02x%02x%02x%02x%02x", coordinate_X.b[0],coordinate_X.b[1],coordinate_X.b[2],coordinate_X.b[3],coordinate_Y.b[0],coordinate_Y.b[1],coordinate_Y.b[2],coordinate_Y.b[3]);
    //*-----Load config--------end
